// Keeps the useAsyncData('ai-worker-online') cache (read via useAiWorker) fresh client-side;
// returns keepFresh so the caller (a client plugin) decides when to start it.
